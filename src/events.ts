...
export const events: Event[] = [
    {date: mdyDate(2,26,2021), time: "6PM", location: "ARC Discord Server", name: "Game Night", description: "" },
    {date: mdyDate(3,12,2021), time: "6PM", location: "ARC Discord Server", name: "Book Club", description: "Reading TBA" },
    {date: mdyDate(3,26,2021), time: "6PM", location: "ARC Discord Server", name: "Film Night", description: "" },
    {date: mdyDate(4,9,2021), time: "6PM", location: "ARC Discord Server", name: "Animal Rights History & Trivia Night", description: "" },
    {date: mdyDate(4,23,2021), time: "6PM", location: "ARC Discord Server", name: "Game Night II", description: "" },
];
